...
class CurrencyDetector:
    ...
    """
    def __init__(self, train_path:str, test_path:str,shape:list=[196,196],labels:int=7):
        """
        ...
        self.val_data_gen = self.train_gen.flow_from_directory(self.test_path,
                                                               target_size=self.shape,
                                                               class_mode='categorical',
                                                               batch_size=32)
    ...
    def make_vgg16_model(self):
        ...
        vgg = VGG16(weights='imagenet',include_top=False,input_shape=tuple(self.shape+[3]))
...
test_dir =  "indian_currency_new/validation"

cd = CurrencyDetector(train_path=train_dir,test_path=test_dir)
cd.train_model(epochs=30)